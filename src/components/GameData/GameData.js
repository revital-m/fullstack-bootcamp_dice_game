    ...
    return (
      <div className="data-container">
          <section className="data-container__dices">
            <Button handleClick={this.props.handleClick} name="rollDice" icon="fas fa-dice" btnText="Roll Dice"/>
            <Dice numRooled={this.props.numRooled0}/>
            <Dice numRooled={this.props.numRooled1}/>
            <Button handleClick={this.props.handleClick} name="hold" icon="fas fa-hand-holding" btnText="Hold"/>
          </section>
